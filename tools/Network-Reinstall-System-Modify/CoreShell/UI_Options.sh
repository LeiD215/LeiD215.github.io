...
wget -N --no-check-certificate https://github.com/LeiD215/LeiD215.github.io/raw/master/tools/Network-Reinstall-System-Modify/Network-Reinstall-System-Modify.sh && chmod a+x Network-Reinstall-System-Modify.sh
